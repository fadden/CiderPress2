...
namespace AppCommon {
    ...
    public static class FileTypes {
        ...
        private static readonly string[] sFileTypeNames = new string[] {
            "NON", "BAD", "PCD", "PTX", "TXT", "PDA", "BIN", "FNT",     // $00
            "FOT", "BA3", "DA3", "WPF", "SOS", "$0D", "$0E", "DIR",
            "RPD", "RPI", "AFD", "AFM", "AFR", "SCL", "PFS", "$17",     // $10
            "$18", "ADB", "AWP", "ASP", "$1C", "$1D", "$1E", "$1F",
            "TDM", "$21", "$22", "$23", "$24", "$25", "$26", "$27",     // $20
            "$28", "$29", "8SC", "8OB", "8IC", "8LD", "P8C", "$2F",
            "$30", "$31", "$32", "$33", "$34", "$35", "$36", "$37",     // $30
            "$38", "$39", "$3A", "$3B", "$3C", "$3D", "$3E", "$3F",
            "DIC", "OCR", "FTD", "$43", "$44", "$45", "$46", "$47",     // $40
            "$48", "$49", "$4A", "$4B", "$4C", "$4D", "$4E", "$4F",
            "GWP", "GSS", "GDB", "DRW", "GDP", "HMD", "EDU", "STN",     // $50
            ...
            "WP ", "$A1", "$A2", "$A3", "$A4", "$A5", "$A6", "$A7",     // $a0
            "$A8", "$A9", "$AA", "GSB", "TDF", "BDF", "$AE", "$AF",
            "SRC", "OBJ", "LIB", "S16", "RTL", "EXE", "PIF", "TIF",     // $b0
            "NDA", "CDA", "TOL", "DVR", "LDF", "FST", "$BE", "DOC",
            "PNT", "PIC", "ANI", "PAL", "$C4", "OOG", "SCR", "CDV",     // $c0
            "FON", "FND", "ICN", "$CB", "$CC", "$CD", "$CE", "$CF",
            "$D0", "$D1", "$D2", "$D3", "$D4", "MUS", "INS", "MDI",     // $d0
            "SND", "$D9", "$DA", "DBM", "$DC", "DDD", "$DE", "$DF",
            "LBR", "$E1", "ATK", "$E3", "$E4", "$E5", "$E6", "$E7",     // $e0
            "$E8", "$E9", "$EA", "$EB", "$EC", "$ED", "R16", "PAS",
            "CMD", "$F1", "$F2", "$F3", "$F4", "$F5", "$F6", "$F7",     // $f0
