...
namespace DiskArc {
    ...
    public sealed class FileAttribs {
        ...
        public const int FILE_TYPE_OBJ = 0xb1;
        public const int FILE_TYPE_LIB = 0xb2;
        public const int FILE_TYPE_S16 = 0xb3;
        public const int FILE_TYPE_RTL = 0xb4;
        public const int FILE_TYPE_EXE = 0xb5;
        public const int FILE_TYPE_PIF = 0xb6;
        public const int FILE_TYPE_TIF = 0xb7;
        public const int FILE_TYPE_NDA = 0xb8;
        public const int FILE_TYPE_CDA = 0xb9;
        public const int FILE_TYPE_TOL = 0xba;
        public const int FILE_TYPE_DVR = 0xbb;
        public const int FILE_TYPE_LDF = 0xbc;
        public const int FILE_TYPE_FST = 0xbd;
        public const int FILE_TYPE_PNT = 0xc0;
        public const int FILE_TYPE_PIC = 0xc1;
        public const int FILE_TYPE_ANI = 0xc2;
