...
namespace DiskArc.FS {
    ...
    public class ProDOS : IFileSystem {
        ...
        /// <summary>
        /// <para>ProDOS boot block.  Blocks 0 and 1 are reserved, but only block 0 is used
        /// (block 1 can hold a SOS boot loader).  Some hard drive images have an alternating
        /// pattern in block 1, but on most disks it's just zeroed out.</para>
        ///
        /// <para>This boot block was generated by the ProDOS FST in GS/OS 6.0.1 for an 800KB
        /// floppy disk.  Variations exist, but this should work for everything.</para>
        ///
        /// <para>ProDOS and GS/OS are copyright Apple Computer, Inc.</para>
        /// </summary>
