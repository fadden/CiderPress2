...
namespace cp2 {
    ...
    static class CP2Main {
        ...
        private static Command[] sCommands = {
            ...
            new Command(names: new string[] { "un-binscii", "unbsc" },
                summary: "extracts BinSCII segments from text files",
                usage: "<bsc-file> [bsc-file...]",
                needsArchive: true, acceptsMultipleArgs: true,
                handler: MiscUtil.HandleUnBinSCII),
        ...
        private static bool HandleVersion(string cmdName, string[] args, ParamsBag parms) {
            ...
            Console.WriteLine("Settings file " + (info.Exists ? "is" : "would be") +
                " '" + settingsPath + "'");
            Console.WriteLine();
            Console.WriteLine("Copyright 2026 faddenSoft - https://ciderpress2.com/");
