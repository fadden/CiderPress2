...
namespace CommonUtil {
    ...
    /// </summary>
    /// <remarks>
    /// <para>This has only been tested with the GIF images created by the Windows Media GifEncoder,
    /// which are GIF89a with no global color table.</para>
    ///
    /// <para>References:
    ///   <see href="https://www.w3.org/Graphics/GIF/spec-gif87.txt"/>
    ///   <see href="https://www.w3.org/Graphics/GIF/spec-gif89a.txt"/>
    /// </para>
    /// </remarks>
    public class UnpackedGif {
        ...
        public class GraphicRenderingBlock {
            ...
            private GraphicRenderingBlock() {
                LocalColorTable = RawData.EMPTY_BYTE_ARRAY;
                ImageData = RawData.EMPTY_BYTE_ARRAY;
            }
        ...
        /// </summary>
        private UnpackedGif() {
            GlobalColorTable = RawData.EMPTY_BYTE_ARRAY;
        }
