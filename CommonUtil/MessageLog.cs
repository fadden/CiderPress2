...
namespace CommonUtil {
    ...
    public abstract class MessageLog {
        ...
        /// </summary>
        protected DateTime mStartWhen;

        /// <summary>
        /// If set, display time stamps as relative time rather than absolute.
        /// </summary>
        protected bool mShowRelTime = false;

        /// <summary>
        /// Minimum priority level.  Anything below this is ignored.
        /// </summary>
        protected Priority mMinPriority = Priority.Debug;


        /// <summary>
        /// Constructor. Configures min priority to Debug.
        /// </summary>
        public MessageLog() : this(Priority.Debug) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="prio">Minimum log priority level.</param>
        public MessageLog(Priority prio) {
            mMinPriority = prio;
        ...
        public abstract void Log(Priority prio, string message);
    ...
    /// </summary>
    public class SimpleMessageLog : MessageLog {
        private static readonly char[] sSingleLetter = { 'V', 'D', 'I', 'W', 'E', 'S' };
        ...
        private struct LogEntry {
            ...
            public LogEntry(DateTime when, Priority prio, string msg) {
                mWhen = when;
                mPriority = prio;
                mText = msg;
            }
        ...
        public override void Log(Priority prio, string message) {
            ...
            LogEntry ent = new LogEntry(DateTime.Now, prio, message);
        ...
        public override string ToString() {
            // Use WriteToFile() or WriteToString() to see the actual log.
            return "MessageLog has " + mEntries.Count + " entries";
        }
    }
}
