...
namespace CommonUtil {
    /// <summary>
    /// Version number container, with comparison operators.  Instances are immutable.
    /// </summary>
    /// <remarks>
    /// See <see href="https://semver.org/"/> for explanation of system.
    /// </remarks>
    public struct Version {
        ...
        public static Version Parse(string str) {
            try {
                ...
                // TODO(someday): parse the preRel component
        ...
        /// <summary>
        /// Returns a slightly shorter version string, suitable for use in build tags.
        /// </summary>
        public string GetBuildTag() {
            if (this == NO_VERSION) {
                ...
                return string.Format("{0}.{1}.{2}-{3}{4}", Major, Minor, Patch,
                    PreReleaseType.ToString().ToLower()[0], PreRelease);
            }
        }

        /// <summary>
        /// Returns the standard semantic version string.
        /// </summary>
