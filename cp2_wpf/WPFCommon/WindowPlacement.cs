 ...
 *
 * (I prefer JSON, but the System.Text.Json serializer doesn't seem to work for this -- it just
 * returns an empty string -- and it's not worth doing a manual unboxing.)
 */
