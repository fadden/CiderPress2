...
namespace CommonUtil {
    ...
    public static class Font8x8 {
        ...
        /// <summary>
        /// <para>Returns an 8-byte array for the specified character.  Each byte represents one
        /// row.  The first byte holds the top row, and the most significant bit in each
        /// byte is the leftmost pixel.</para>
        ///
        /// <para>If no glyph is defined, returns the Unicode REPLACEMENT CHARACTER glyph.</para>
        /// </summary>
